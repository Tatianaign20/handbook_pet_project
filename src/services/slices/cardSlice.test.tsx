...
jest.mock('../../utils/handbook-api', () => ({
  ...
  delCardApi: jest.fn(() => Promise.resolve({menuItemId:testCard.menuItemId, id: testCard.id})),
...
describe('проверка addCard rejected', () => {
  ...
  it('Проверка addCard rejected', async () => {
    ...
    try {
      await store.dispatch(
        addCard.rejected(mockError, '', testCard)
      );
    } catch (error) {}
...
describe('проверка delCard rejected', () => {
  ...
  it('Проверка delCard rejected', async () => {
    ...
    try {
      await store.dispatch(
        delCard.rejected(mockError, '', { menuItemId: testCard.menuItemId, id: testCard.id})
      );
    } catch (error) {}
...
describe('проверка delCard pending', () => {
  ...
  store.dispatch(delCard( { menuItemId: testCard.menuItemId, id: testCard.id}));
...
describe('проверка addCard fulfilled', () => {
  ...
  describe('проверка delCard fulfilled', () => {
    ...
    it('Проверка delCard fulfilled', async () => {
      await store.dispatch(delCard({menuItemId: testCard.menuItemId, id: testCard.id}));
